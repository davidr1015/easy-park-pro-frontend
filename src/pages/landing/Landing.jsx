...
export  function Landing() {
    return (
        <div className="min-h-screen text-black dark:text-white  max-w-6xl">
          ...
          <section style={{
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-center">
              <h1 className="text-5xl font-bold max-w-4xl text-white">Bienvenidos a EasyPark Pro <br /> <span className="text-2xl">Tu Solución de Parqueo en Colombia</span></h1>
              <Link to={PATHS.PUBLIC.LOGIN.path} className="mt-6 bg-purple-800 text-white px-6 py-3 rounded-full hover:bg-zinc-200 font-bold">ENCUENTRA TU PARQUEADERO</Link>
            </div>
          </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 ">
              <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-x-8 md:gap-y-10">
                ...
                <div className="relative">
                  <dt>
                    <p className="text-lg leading-6 font-medium ">Beneficios Exclusivos</p>
                  </dt>
                  <dd className="mt-2 text-base text-zinc-500 dark:text-zinc-400">
        ...
        <div className="bg-zinc-100 dark:bg-zinc-900 py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative bg-black dark:bg-zinc-900 shadow-xl rounded-lg overflow-hidden">
              <img className="w-full h-64 object-cover opacity-70" src="https://images.unsplash.com/photo-1506521781263-d8422e82f27a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Insurance Innovation" />
              <div className="absolute inset-0 bg-zinc-900 bg-opacity-50 flex items-center justify-center">
                <div className="text-center text-white px-4">
                  <h3 className="text-2xl font-bold text-white">Con EasyPark Pro, tu parqueadero está siempre a un clic de distancia.</h3>
                </div>
              </div>
            </div>
          </div>
