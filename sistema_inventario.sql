...
-- Started on 2024-04-02 08:08:44
...
COPY public.cargos (id, cargo, trial223) FROM stdin;
1	DESARROLLO	T
2	ADMINISTRACION	\N
3	LIDER	\N
4	CONTABILIDAD	\N
...
COPY public.categoria (id, categoria, trial223) FROM stdin;
16	ALMACENAMIENTOS	T
42	TABLETS	T
45	PPS	T
46	CELULARES	\N
\.
...
COPY public.empleado (id, cedula, nombre, apellido, correo, id_rol, id_empresa, password, activo, telefono, direccion, ciudad, token_verificacion, id_cargo, estado, trial223) FROM stdin;
43	100300215	GUSTAVO	GARNAU	DMDR151010@GMAIL.COM	1	1	$2b$10$DBewxWmmj9UHmFXAAy93VuxzWDaM4xqIr.fhx7//4rV8XscjCJ2we	0	3024481093	ENDUMUNDOLOPEZ	MONTERIA	69a090a8-d2df-4574-9504-e341ed475c36	1	\N	\N
45	1003002515	GUSTAVO	GARNAU	DMDR15221010@GMAIL.COM	1	1	$2b$10$ZfABuTRc2ewMEcs9GstdkOriX0xOnLXUzlTMFC8nsxw66IN/Aowgu	0	3024481093	ENDUMUNDOLOPEZ	MONTERIA	edb6ba42-93a7-49d0-8d69-9a46457382de	1	\N	\N
46	156329874	ESTEBAN	ARRIETA	DMDR1233@GMAIL.COM	1	1	$2b$10$B/cptVHZHoMDOXWwRWZMF.Itpz0iOF5VH9MBys1.wWQuyJfWMUgkC	0	3225469851	RECREO	MONTERIA	9ab3bcca-0488-4860-af5b-be982876222c	1	\N	\N
29	1003004328	DAVID RICARDO	DELGADO MEDINA	DMDR1015@GMAIL.COM	1	1	$2b$10$Y8g7IkrafjgbnuanQjhd8O34rR9jZLRP1IJ7IG1UQ//VSQN/Ht9y.	1	3196846680	CANTACLARO	MONTERIA	7da560ad-f84c-4c59-8b0f-b7b548a70681	1		T
37	100300254	GUSTAVO	GARNAU	DMDR1010@GMAIL.COM	2	1	$2b$10$bDyM8wnEg7ydSzuGhkUyv.1FqzZ9gQRGVyyba0LTPHPwTw2GWryE.	1	3024481093	ENDUMUNDOLOPEZ	MONTERIA	\N	1	\N	\N
42	12569854	ARTURO	PEREZ	APEREZ@GMAIL.COM	1	1	$2b$10$aSFzD1UOp3/UFKnezYX0IuRUsgev9lOnyeoj77JcfCjc9P9YDkur.	0	3259874562	123456789	BOGOTA	74577b89-01a1-49ac-8b9b-81d63c3e6edc	1	\N	\N
\.
...
COPY public.empresa (id, nit, razon_social, direccion, telefono, representante_legal, logotipo, pais, ciudad, trial223) FROM stdin;
1	1	TecnoEmprendedores	Carrera 123 # 456	+57 123 456 7890	Juan David Pérez	logo_tecnOEM.png	colombia	monteria\r\n	T
2	2	InnoDigital	Calle 789 # 012	+57 456 789 1234	María Luisa Gómez	logo_innoDigital.png	colombia	bogota	T
\.
...
COPY public.equipo (id, num_activo, marca, modelo, serial, estado, especificaciones, id_categoria, activo, trial223) FROM stdin;
8	13	MC	MD	SR	2	ESPC	16	0	T
12	4	HP	BOOK HHTCBP3465	100352130G	3	I9 115123	42	\N	\N
13	8	AZUS	BOOK HHTCBP3465	100352130G	3	I9 115123	42	\N	\N
18	15	DELL	IDEAPAD	SNJGD2729829903ZL	2	RAM: 32GB PROCESADOR: RYZEN 9	46	\N	\N
14	9	AZUS	BOOK HHTCBP3465	100352130G	2	I7 115123	42	\N	\N
\.
...
COPY public.mantenimiento (id, id_equipo, fecha_mantenimiento, descripcion_mantenimiento, trial226) FROM stdin;
1	3	2023-02-15	Limpieza general, actualización BIOS	T
\.
...
COPY public.prestamo (id, fecha_inicio, fecha_devolucion_esperada, fecha_devolucion_real, estado, id_empleado, id_responsable, id_equipo, cargador, observaciones, trial226) FROM stdin;
8	2024-03-26	\N	\N	ENTREGA DOTACION	29	29	8	1	NINGUNA	T
24	2023-01-05	2023-01-19	2023-01-19	1	29	37	8	1	Prestamo para curso de Python	\N
25	2023-02-10	2023-02-24	2023-02-24	1	29	37	12	1	Prestamo para proyecto de investigación	\N
26	2023-03-15	2023-03-31	2023-03-31	1	29	37	13	1	Prestamo para tesis de grado	\N
27	2023-04-01	2023-04-15	\N	1	29	37	14	1	Prestamo para taller de programación	\N
28	2023-05-05	2023-05-19	\N	1	29	37	8	1	Prestamo para curso de diseño web	\N
29	2023-06-10	2023-06-24	\N	1	29	37	12	1	Prestamo para diplomado en marketing digital	\N
31	2023-08-05	2023-08-19	\N	1	29	37	14	1	Prestamo para curso de fotografía	\N
32	2023-09-10	2023-09-24	\N	1	29	37	8	1	Prestamo para curso de guitarra	\N
33	2023-10-01	2023-10-15	\N	1	29	37	12	1	Prestamo para curso de baile	\N
34	2023-11-05	2023-11-19	\N	1	29	37	13	1	Prestamo para curso de cocina	\N
35	2023-12-10	2023-12-24	\N	1	29	37	14	1	Prestamo para curso de primeros auxilios	\N
36	2024-01-05	2024-01-19	\N	1	29	37	8	1	Prestamo para curso de liderazgo	\N
38	2024-03-15	2024-03-31	\N	1	29	37	13	1	Prestamo para curso de robótica	\N
30	2023-07-01	2023-07-15	\N	1	37	37	13	1	Prestamo para curso de inglés	\N
37	2024-02-10	2024-02-24	\N	1	37	37	12	1	Prestamo para curso de oratoria	\N
39	2024-04-01	2024-04-26	\N	1	42	29	18	0	PARA PRUEBA DE APp	\N
40	2024-04-01	2024-04-26	\N	1	42	29	18	0	PARA PRUEBA DE APp	\N
41	2024-04-01	2024-04-12	\N	1	46	29	14	1	PRUEBa	\N
\.
...
COPY public.rol (id, descripcion, trial226) FROM stdin;
1	Administrador	T
2	responsable	T
3	colaborador	T
\.
...
COPY public.rol_permisos (id, id_rol, modulo, permiso_creacion, permiso_edicion, permiso_eliminacion, permiso_lectura, trial226) FROM stdin;
1	1	1	1	1	1	1	T
2	1	2	1	0	0	1	T
3	1	3	1	0	1	1	T
\.
...
-- Completed on 2024-04-02 08:08:44
